...
API_KEY = 'AIzaSyC1uIzkijAAPEX4twuU0sFbTcQRUUDsvF8'
...
TABLE_ID = '117A2kPexfL9ildGkWdDCF_rQ1DQvPYMo4f2IvZXw'
# This is the default columns for the query
query_cols = []
query_values = ['China'] #Change to be the value(s) you're querying in the column you've specified
